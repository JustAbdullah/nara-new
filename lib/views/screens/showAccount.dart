                ...
                child: Align(
                  ...
                  child: Container(
                    ...
                    child: Stack(children: [
                      ...
                      Visibility(
                        visible: controller.is_write_address.value == 2,
                        child: Padding(
                          padding: EdgeInsets.only(top: screenHeight * 0.12),
                          child: Padding(
                            padding: EdgeInsets.symmetric(
                      ...
                      child: Container(
                        ...
                        child: FutureBuilder(
                          ...
                          builder:
                            ...
                            if (controller.isShoppingCartEmpty.value == false) {
                              return Center(
                                  child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                              ...
                              return ListView.builder(
                                  ...
                                  itemBuilder: (context, i) {
                                    ...
                                    WidgetsBinding.instance
                                      ...
                                      if (controller.isAddThetotalPriceToMemory
                                              .value ==
                                          false) {
...
/////////////
                  Visibility(
                      visible: controller.isLoadingAddIntoTheShoppingCart.value,
                      child: Container(
                        width: screenWidth,
                        height: screenHeight,
                        color: Colors.black26,
                      ...
                      child: Align(
                        ...
                        child: Container(
                          ...
                          child: FutureBuilder(
                            ...
                            builder:
                                (BuildContext context, AsyncSnapshot snapshot) {
                              if (controller.isOrdersEmpty.value == true) {
                                return Center(
                                    child: Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                                      ...
                                                      onTap: () {
                                                        if ("${snapshot.data['data'][i]['order_status'].toString()}" ==
                                                          ...
                                                          controller
                                                                  .id_of_orderAdd =
                                                              "${snapshot.data['data'][i]['id_of_order'].toString()}";
                                                          controller.getCompleteprocessOrder(
                                                              controller
                                                                  .id_of_orderAdd
                                                                  .toString());
                                                          controller
                        ...
                        child: Container(
                          ...
                          child: Stack(children: [
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: Align(
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          controller.OrderDetails.value = false;
                                        },
                                        child: Text(
                                          "249".tr,
                                          style: TextStyle(
                            ...
                            Visibility(
                              ...
                              child: Padding(
                                padding:
                                    EdgeInsets.only(top: screenHeight * 0.288),
                                child: Padding(
                                  padding: EdgeInsets.symmetric(
                                      horizontal: screenWidth * 0.04),
                                  child: Align(
                                  ...
                                  child: Align(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: AnimatedContainer(
                                          ...
                                          width: controller.howtoPay.value == 1
                                              ? screenWidth * 0.3
                                              : screenWidth * 0.27,
                                          decoration: BoxDecoration(
                                              color:
                                ...
                                child: Padding(
                                  ...
                                  child: Align(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: AnimatedContainer(
                                          duration: Duration(seconds: 1),
                                          width: controller.howtoPay.value == 2
                                              ? screenWidth * 0.3
                                              : screenWidth * 0.27,
                                          decoration: BoxDecoration(
                                              color:
                            ...
                            Visibility(
                                ...
                                child: Padding(
                                  ...
                                  child: Align(
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          controller.makeTheOrderIsConfim(
                                              controller.idorderAdd.toString(),
                                          ...
                                          controller
                                              .addIntoCompleteprocessOrder(
                                                  controller.idorderAdd
                                                      .toString(),
                                                  controller.id_of_orderAdd
                                                      .toString(),
                                                  controller.totalAdd
                                                      .toString(),
                                                  controller.howtoPay.value
                                                      .toString());
                                        },
                                        child: AnimatedContainer(
                                          duration: Duration(seconds: 1),
                            ...
                            Visibility(
                                ...
                                child: Padding(
                                  padding:
                                      EdgeInsets.only(top: screenHeight * 0.33),
                                  child: Padding(
                                    padding: EdgeInsets.symmetric(
                                        horizontal: screenWidth * 0.04),
                                    child: Align(
                            ...
                            Visibility(
                                ...
                                child: Padding(
                                  padding:
                                      EdgeInsets.only(top: screenHeight * 0.47),
                                  child: Padding(
                                    padding: EdgeInsets.symmetric(
                                        horizontal: screenWidth * 0.04),
                                    child: Align(
                            ...
                            Visibility(
                                ...
                                child: Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          controller.OrderInfoShoppingCart
                                              .value = true;
                                        },
                                        child: Container(
                            ...
                            Visibility(
                                visible: controller.OrderInfoShoppingCart.value,
                                child: Align(
                                    alignment: Alignment.center,
                                    child: Container(
                                        width: screenWidth,
                                                                  ...
                                                                  child: Stack(
                                                                      children: [
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            Align(
                                                                                ...
                                                                                child: Container(
                                                                                  child: Padding(
                                                                                      padding: EdgeInsets.only(top: screenHeight * 0.05, right: screenWidth * 0.07, left: screenWidth * 0.07),
                                                                                      child: Container(
                                                                                          width: screenWidth * 0.4,
                                                                                          child: GetX<ChangeLanguageToLocale>(
                                                                                            builder: (scontroller) => scontroller.changeLangData == 1
                                                                        ...
                                                                        Align(
                                                                            ...
                                                                            child: Container(
                                                                              child: Padding(
                                                                                  padding: EdgeInsets.only(top: screenHeight * 0.07, right: screenWidth * 0.05, left: screenWidth * 0.05),
                                                                                  child: Row(
                                                                                    mainAxisAlignment: MainAxisAlignment.center,
                                                                                    children: [
                                                                                      Text(
