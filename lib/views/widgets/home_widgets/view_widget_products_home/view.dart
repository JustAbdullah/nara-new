...
class ViewTheWidget extends StatelessWidget {
                        ...
                        child: InkWell(
                            onTap: () async {
                              ...
                              homeController.product.imageProtwo =
                                  snapshot.data['data'][i]['image_product_two'];
                                  ...
                                  child: Column(children: [
                                      ...
                                      children: [
                                        Align(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(
                                                "${homeController.theNameOfCoins.value}",
                                                style: TextStyle(
                                                    fontFamily: 'Cairo',
                                              ...
                                              Text(
                                                (homeController
                                                            .theCoins.value ==
                                                        2
                                                    ? "${homeController.theOldPrice.toStringAsFixed(2)}"
                                                    : "${snapshot.data['data'][i]['old_price'].toString()}"),
                                                style: TextStyle(
                                                    fontFamily: 'Cairo',
                                                    color: AppColors.WelcomeRed,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          (homeController.theCoins.value == 2
                                              ? "${homeController.thePrice.toStringAsFixed(2)}"
                                              : "${snapshot.data['data'][i]['price_product'].toString()}"),
                                          style: TextStyle(
                                              fontFamily: 'Cairo',
                                              color: AppColors
