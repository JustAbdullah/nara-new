    ...
    return GetX<HomeController>(
        builder: (controller) => Stack(
              children: [
                ...
                //////////////////////////////////loading  login to api ///////////////////////
                Visibility(
                    visible: controller.loadingLoginAccount.value,
                    child: Container(
                      width: screenWidth,
                      height: screenHeight,
                      color: Colors.black26,
                ...
                Visibility(
                    visible: controller.isAreadyLoginAccount.value,
                    child: Container(
                      width: screenWidth,
                      height: screenHeight,
                      color: Colors.black26,
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          onTap: () {
                            controller.SignUpAuth.value = false;
                            controller.LogInAuth.value = false;
                            controller.isAreadyLoginAccount.value = false;

                            controller.showAccount.value = false;
                            controller.makeAniTrue();
                            Get.to(Home());
                          },
                          child: Container(
                ...
                Visibility(
                    visible: controller.youDontEnterDataLogin.value,
                    child: Align(
                      alignment: Alignment.center,
                      child: Container(
                        width: screenWidth * 0.60,
                        ...
                        child: Stack(children: [
                          Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                controller.youDontEnterDataLogin.value = false;
                              },
                              child: Container(
                                width: screenWidth * 0.10,
                                height: screenHeight * 0.04,
                ...
                Visibility(
                    visible: controller.errorAboutTheAccountLogin.value,
                    child: Align(
                      alignment: Alignment.center,
                      child: Container(
                        width: screenWidth * 0.60,
                        ...
                        child: Stack(children: [
                          Align(
                            ...
                            child: InkWell(
                              onTap: () {
                                controller.errorAboutTheAccountLogin.value =
                                    false;
                              },
                              child: Container(
                                width: screenWidth * 0.10,
