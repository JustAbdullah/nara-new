...
class ViewTheProductsMainTypesNameType extends StatelessWidget {
  const ViewTheProductsMainTypesNameType({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
        future: homeController
            .searchingBySubType(homeController.theTypeSearching.toString()),
        builder: (BuildContext context, AsyncSnapshot snapshot) {
          if (snapshot.hasData) {
            return homeController.isNoSubTheData.value == true
                ? Column(
