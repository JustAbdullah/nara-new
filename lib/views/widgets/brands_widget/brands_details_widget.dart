...
class BrandsTheDetailsWidget extends StatefulWidget {
  const BrandsTheDetailsWidget({super.key});

  @override
  State<BrandsTheDetailsWidget> createState() => _BrandsTheDetailsWidgetState();
}

class _BrandsTheDetailsWidgetState extends State<BrandsTheDetailsWidget> {
  @override
                    ...
                    child: Container(
                        ...
                        child: FutureBuilder(
                            ...
                            builder:
                              ...
                              if (snapshot.hasData) {
                                return homeController.noDataBrandList.value ==
                                        true
                                    ? Column(
                                        mainAxisAlignment:
                                                                  ...
                                                                  Align(
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Text(
                                                                          (int.parse((snapshot.data['data'][i]['old_price'].toString())) * homeController.theCountPrice.value)
                                                                              .toStringAsFixed(2),
                                                                          style: TextStyle(
                                                                              fontFamily: 'Cairo',
                                                                              color: AppColors.WelcomeRed,
