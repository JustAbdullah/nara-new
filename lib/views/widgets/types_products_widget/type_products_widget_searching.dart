...
class TypeTheProductsWidgetSearching extends StatelessWidget {
  const TypeTheProductsWidgetSearching({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<HomeController>(
        builder: (controller) => FutureBuilder(
            future: controller.getAllDataProductsSearchingTypes(
                controller.TheNameProductsToSearching.value.toString()),
                        ...
                        return Padding(
                            ...
                            child: InkWell(
                                onTap: () async {
                                  ...
                                  homeController.getSizesTheProducts(
                                      homeController.product.idPro = snapshot
                                          .data['data'][i]['id_product']
                                          .toString());
