...
class ThebrandsSearching extends StatelessWidget {
  const ThebrandsSearching({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<HomeController>(
        builder: (controller) => FutureBuilder(
            future: homeController.getAllDataBrandsSearchingTypes(
                            ...
                            child: InkWell(
                                onTap: () async {
                                  ...
                                  homeController.Thebrand.idBrand = snapshot
                                      ...
                                      .toString();
                                  homeController.getDataProductsBrands(snapshot
                                      .data['data'][i]['id_brand']
                                      .toString());
                                  homeController.DetailsBrands.value = true;
                                },
                                child: Container(
