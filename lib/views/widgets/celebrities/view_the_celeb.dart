...
import 'celebrities.details.dart';

class view_the_celeb extends StatelessWidget {
  const view_the_celeb({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: homeController.getAllDataCelebrities(),
          ...
          if (data == null) {
            ...
            return GridView.builder(
                ...
                itemBuilder: (context, i) {
                  ...
                  homeController.celebs.nameCeleEn = snapshot.data['data'][i]
                          ['name_celebrities_en']
                      .toString();
                  ;
                  homeController.celebs.ImageCele =
                  ...
                  return Padding(
                      ...
                      child: InkWell(
                          onTap: () async {
                            ...
                            homeController.celebs.idCele = snapshot.data['data']
                                    [i]['id_celebrities']
                                .toString();
